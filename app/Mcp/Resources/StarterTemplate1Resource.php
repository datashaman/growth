...
#[Description('Apply-manifest-ready starter for a Rigor 1 project. Provides a project + plan (scope/approach) + one stakeholder, concern, requirement, and architecture context view. Read this, replace the TODO placeholders, then call apply-manifest.')]
