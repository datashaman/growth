...
class MockupDesignBriefResource extends Resource implements HasUriTemplate
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $md .= "- After creating or refining a mockup, read its metadata resource (`growth://mockups/{mockup}` or `growth://mockups/{mockup}/{revision}`) for the raw HTML URI, preview HTML URI, signed screenshot asset URL, and MCP screenshot resource URI.\n";
