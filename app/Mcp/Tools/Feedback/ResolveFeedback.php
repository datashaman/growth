...
use App\Growth\Transitions\ResolveFeedback as ResolveFeedbackTransition;
...
class ResolveFeedback extends Tool
{
    public function handle(Request $request): ResponseFactory
    {
        ...
        try {
            $transition = (new ResolveFeedbackTransition)->apply($feedback, auth()->user(), $data['reason'] ?? null);
