...
use App\Growth\Transitions\ReopenFeedback as ReopenFeedbackTransition;
...
class ReopenFeedback extends Tool
{
    public function handle(Request $request): ResponseFactory
    {
        ...
        try {
            $transition = (new ReopenFeedbackTransition)->apply($feedback, auth()->user(), $data['reason'] ?? null);
