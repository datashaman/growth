...
use App\Growth\Transitions\MarkDeploymentFailed as MarkDeploymentFailedTransition;
...
class MarkDeploymentFailed extends Tool
{
    public function handle(Request $request): ResponseFactory
    {
        ...
        try {
            $transition = (new MarkDeploymentFailedTransition)->apply($deployment, auth()->user(), $data['reason'] ?? null);
