...
use App\Growth\Transitions\AcceptRisk as AcceptRiskTransition;
...
#[Description('Accept a risk: move it from identified or assessed to accepted. Rejects any other source status with a clear message. Records a status transition with the acting user and timestamp.')]
class AcceptRisk extends Tool
{
    public function handle(Request $request): ResponseFactory
    {
        ...
        try {
            $transition = (new AcceptRiskTransition)->apply($risk, auth()->user(), $data['reason'] ?? null);
