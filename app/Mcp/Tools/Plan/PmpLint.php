...
#[Description('Lint a project against delivery planning PMP completeness rules. Returns a flat list of findings with severity, rule code, message, and the subject artifact.')]
