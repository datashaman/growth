...
use App\Growth\Transitions\ReopenWorkItem as ReopenWorkItemTransition;
...
class ReopenWorkItem extends Tool
{
    public function handle(Request $request): ResponseFactory
    {
        ...
        try {
            $transition = (new ReopenWorkItemTransition)->apply($workItem, auth()->user(), $data['reason'] ?? null);
