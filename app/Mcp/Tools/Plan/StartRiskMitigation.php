...
use App\Growth\Transitions\StartRiskMitigation as StartRiskMitigationTransition;
use App\Models\Risk;
...
class StartRiskMitigation extends Tool
{
    public function handle(Request $request): ResponseFactory
    {
        ...
        try {
            $transition = (new StartRiskMitigationTransition)->apply($risk, auth()->user(), $data['reason'] ?? null);
