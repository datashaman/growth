...
use App\Growth\Transitions\SubmitChangeRequest as SubmitChangeRequestTransition;
...
class SubmitChangeRequest extends Tool
{
    public function handle(Request $request): ResponseFactory
    {
        ...
        try {
            $event = (new SubmitChangeRequestTransition)->apply($changeRequest, auth()->user(), $data['reason'] ?? null);
