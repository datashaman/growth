...
use App\Growth\Transitions\CancelChangeRequest as CancelChangeRequestTransition;
...
class CancelChangeRequest extends Tool
{
    public function handle(Request $request): ResponseFactory
    {
        ...
        try {
            $event = (new CancelChangeRequestTransition)->apply($changeRequest, auth()->user(), $data['reason'] ?? null);
