...
#[IsDestructive(false)]
#[Description('Create or update an architecture view and optionally sync the concerns it addresses. The viewpoint must be either a project custom viewpoint or one of the built-ins returned by list-architecture-viewpoints. Before generating architecture artifacts, inspect stakeholders, concerns, requirements, existing views/elements, and source citations so the view captures useful agent-facing design context.')]
class UpsertArchitectureView extends Tool
{
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'viewpoint' => $schema->string()->description('Built-in viewpoint name returned by list-architecture-viewpoints, or a project custom viewpoint name')->required(),
