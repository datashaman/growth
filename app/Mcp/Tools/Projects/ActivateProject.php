...
use App\Growth\Transitions\ActivateProject as ActivateProjectTransition;
...
class ActivateProject extends Tool
{
    public function handle(Request $request): ResponseFactory
    {
        ...
        try {
            $transition = (new ActivateProjectTransition)->apply($project, auth()->user(), $data['reason'] ?? null);
