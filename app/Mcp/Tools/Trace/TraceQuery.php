...
#[Description('Walk the traceability graph from any artifact (requirement, concern, design view/element, test plan/case/run, anomaly, stakeholder). Returns a flat node+edge graph up to a configurable depth.')]
