...
#[Description('Look up terms in a user-provided internal glossary extract.')]
class GlossaryLookup extends Tool
{
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            'query' => $schema->string()
                ->description('Term or partial term to look up (case-insensitive)')
                ->required(),
            'mode' => $schema->string()
                ->description('Match mode: "exact", "prefix", or "contains" (default).'),
