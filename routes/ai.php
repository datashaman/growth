...
// application user for owner-scoped tools. Set GROWTH_SURFACE to bind the
// session to a capability surface (#183) — it must match the surface server it
// connects to, and it takes effect only once a user is bound via
// GROWTH_USER_EMAIL/_ID.
